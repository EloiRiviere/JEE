...
public class Affichage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<table><tr><th scope=\"col\">Nom</th><th scope=\"col\">Race</th></tr>");
            for(Animal animal : Creation.getAnimaux())
            {
                out.println("<tr><td>" + animal.getNom() + "</td><td>" + animal.getRace() + "</td></tr>");
            }
            out.println("</table>");
